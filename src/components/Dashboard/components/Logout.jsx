...
return (
  <div style={{width:'100%',height:'100vh'}} className="basic">
    ...
    <div>
    <button style={{margin:'1em',outline:'none',cursor:'pointer',border:'none',padding:'4px 10px',background:"dodgerblue",fontSize:'25px',color:'white'}} onClick={()=>{localStorage.removeItem("currStudentUser");window.location.href="/"}}>
      Yes
    </button>
